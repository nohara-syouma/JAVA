...
<%
    ...
    */
    ...
    // セッション初期化
    if (session.getAttribute("currentmoney") == null || btn != null 
    && btn.equals("reset") && btn.equals("reset")) {
        session.setAttribute("currentmoney", 150000);
    }
    ...
    // 所持金をセッションから取得
    int money = (int) session.getAttribute("currentmoney");//現在は仮で値をセットしている。実際はセッションから取得する
